return {
  ...
  config = function()
    ...
    -- Accent colors used by individual components below (the statusline *theme*
    -- now follows the active colorscheme via theme = "auto").
    local colors = {
      yellow = "#FFDA7B",
    }
    ...
    lualine.setup({
      options = {
        -- Follow the active colorscheme; lualine recomputes this on ColorScheme.
        theme = "auto",
      },
      sections = {
        lualine_a = {
